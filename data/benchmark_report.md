...
| :--- | :--- | :---: | :---: | :--- |
| `BENCH-001` | Coverage | ✅ PASS | 0.04 ms | Is cataract surgery covered in my policy? |
...
| `BENCH-006` | Pre-Auth & Claims | ✅ PASS | 0.02 ms | How many hours prior to planned hospitalization mu |
...
| `BENCH-009` | Waiting Periods | ✅ PASS | 0.02 ms | What is the initial waiting period for non-acciden |
